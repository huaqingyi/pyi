...
let TestController = TestController_1 = class TestController extends src_1.PYIController {
    index() {
        // tslint:disable-next-line:max-classes-per-file
        return src_1.PYIExecption(class extends TestController_1 {
            async throws() {
...
__decorate([
    ...
    __param(1, src_1.Req()),
    __param(2, src_1.Res()),
    __param(3, src_1.Params()),
    __param(4, src_1.Body()),
    __metadata("design:type", Function),
...
//# sourceMappingURL=../../sourcemaps/src/controller/test.controller.js.map
