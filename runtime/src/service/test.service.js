...
let TestService = TestService_1 = class TestService extends src_1.PYIService {
    async testFindAll() {
        // tslint:disable-next-line:max-classes-per-file
        return src_1.PYIExecption(class extends TestService_1 {
            async throws() {
                // throw new Error('不开心 ...');
...
//# sourceMappingURL=../../sourcemaps/src/service/test.service.js.map
