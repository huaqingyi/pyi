...
var sourcemaps = __importStar(require("gulp-sourcemaps"));
var tsc = __importStar(require("gulp-typescript"));
var path_1 = require("path");
var merge2_1 = __importDefault(require("merge2"));
var TSC = /** @class */ (function (_super) {
     ...
     */
    TSC.prototype.runtime = function (src, dest, ts, tsconfig) {
        return __awaiter(this, void 0, void 0, function () {
            var g, tsResult, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                         ...
                         */
                        if (src)
                            this.gulp = gulp_1.default.src(src);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 2, , 4]);
                        g = this.gulp;
                        ...
                        if (!dest)
                            dest = './dist';
                        tsResult = g.pipe(sourcemaps.init())
                            .pipe(ts.createProject(tsconfig)());
                        /**
                         * merge result
                         */
                        return [2 /*return*/, merge2_1.default([
                                tsResult.dts.pipe(gulp_1.default.dest(dest)),
