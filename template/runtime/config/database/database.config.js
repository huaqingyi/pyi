...
let DataBaseConfiguration = class DataBaseConfiguration extends pyi_1.PYIAutoConfiguration {
    constructor() {
        super();
        this.default = {};
...
//# sourceMappingURL=../../sourcemaps/config/database/database.config.js.map
