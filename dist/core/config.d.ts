...
export declare class AppConfigOption extends ConfigurationServer {
    constructor(...props: any);
}
export declare class PYIAutoAppConfiguration<Props> extends PYIAutoConfiguration<Props> {
    static _extends(): typeof PYIAutoAppConfiguration;
    default: AppConfigOption;
