import _ from 'ramda';
declare const request: (method: string, path: string | RegExp) => (target: any, name: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
...
declare const Doc: {
    request: (method: string, path: string | RegExp) => (target: any, name: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
